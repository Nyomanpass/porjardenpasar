...
const slides = [
  {
   title: "Tenis Denpasar Berprestasi",
    description: "Kami adalah wadah pembinaan, seleksi, dan pengembangan bibit unggul tenis Denpasar melalui program pelatihan terstruktur dan turnamen tahunan.",
    image: "hero.jpg"
  },
];
